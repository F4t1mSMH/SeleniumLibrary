...
//        Fill the form
        driver.findElement(By.id("name")).sendKeys("clair");
...
//        Use passcode to submit form
        ...
        //driver.switchTo().frame(0); #if its one
        //driver.switchTo().frame("iframeSubmit"); #more than one iframe or if itd have id 0r name
